...
(function widerComments() {
  ...
  const fixWidth = function fixWidth() {
    ...
    if (rules.length > 0 && translateRules.length > 0) {
      ...
      document.querySelectorAll('section.dt.gm.gn.do.go').forEach((e) => e.style.setProperty('width', '50vw'));
      document.styleSheets[1].insertRule('.n.p > .av.aw.ax.ay.az.ba.bb.w { width: fit-content; left: 0; position: absolute; }');
    } else {
