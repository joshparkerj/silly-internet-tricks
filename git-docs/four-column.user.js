// ==UserScript==
// @name         Four Column Git Docs
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Like the others, redone for git docs
// @author       Josh Parker
// @match        https://git-scm.com/docs/*
// @icon         https://www.google.com/s2/favicons?domain=git-scm.com
// @grant        none
// ==/UserScript==

(function fourColumnGitDocs() {
 const css = `
